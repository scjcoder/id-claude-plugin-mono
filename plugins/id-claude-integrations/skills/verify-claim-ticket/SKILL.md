...
```
Slack #claim_feedback (<SLACK_CHAN_CLAIM_FEEDBACK>)
  → SQS FIFO
  ...
  → HubSpot Tickets (portal <HUBSPOT_PORTAL_ID>, pipeline 892787555)
```
...
Tool: mcp__a0fdd3cf-15f6-464f-b6da-95e9ff898737__slack_read_channel
  channel_id: <SLACK_CHAN_CLAIM_FEEDBACK>
  limit: 5
```
...
| Constant | Value |
|----------|-------|
| Slack channel | `<SLACK_CHAN_CLAIM_FEEDBACK>` (#claim_feedback) |
...
| AWS profile | `install-<AWS_ACCOUNT_ID>` |
