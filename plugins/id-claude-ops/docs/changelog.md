...
### Removed
- `infra/422-reports`: Destroyed all AWS resources provisioned by this OpenTofu module — S3 bucket (`insidedesk-422-reports-<AWS_ACCOUNT_ID>`), IAM user/policy/access key (`insidedesk-422-reports-signer`), and Secrets Manager secret (`insidedesk/422-reports/signer`). Module marked deprecated in README.
