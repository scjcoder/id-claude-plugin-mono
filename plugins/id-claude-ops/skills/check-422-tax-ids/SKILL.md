...
```
https://goldeneye.insidedesk.net/production/admin/facility/{facility_id}/details
```
...
- The GoldenEye URL always uses the **production** environment: `goldeneye.insidedesk.net/production/...`
