...
description: >
  ...
  "ticket this facility", or pastes a goldeneye.insidedesk.net facility URL
...
| Plugin Slack channel | `D0B0YUWV1UK` |
...
The GoldenEye dashboard (`goldeneye.insidedesk.net`) requires Google SSO.
...
⚠️ Duplicate ticket found: [subject]
   https://app.hubspot.com/contacts/19834291/ticket/[id]
```
...
```python
ticket_url = f"https://app.hubspot.com/contacts/19834291/ticket/{ticket_id}"
```
