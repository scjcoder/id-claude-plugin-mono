...
|---|---|
| Production | `https://goldeneye.insidedesk.net/production/` |
| Testing | `https://goldeneye.insidedesk.net/testing/` |
| UAT / Staging | `https://goldeneye.insidedesk.net/uat-staging/` |
...
ALLOWED_BASES = [
    'https://goldeneye.insidedesk.net/production/',
    'https://goldeneye.insidedesk.net/testing/',
    'https://goldeneye.insidedesk.net/uat-staging/',
]
