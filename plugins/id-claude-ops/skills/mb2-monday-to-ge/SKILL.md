...
| GoldenEye environment | Production — `https://goldeneye.insidedesk.net/production/` |
...
| Slack summary channel | `D0B0YUWV1UK` |
...
Post to Slack channel `D0B0YUWV1UK` via Desktop Commander:
