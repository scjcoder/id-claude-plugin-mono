...
```
https://goldeneye.insidedesk.net/production/admin/facility?search=<URL-encoded facility name>
```
...
```
https://goldeneye.insidedesk.net/production/admin/facility/<FACILITY_ID>/snapshots?dateFrom=<YESTERDAY>&dateTo=<TODAY>&pageSize=10
```
