# Security Review — `id-claude-reporting`
...
|---|---|---|---|---|
| HIGH | detect-secrets | `Secret Keyword` | Potential committed secret | `skills/422-tax-id-report/create_tickets_2026_06_08.py:8` |
| HIGH | detect-secrets | `Secret Keyword` | Potential committed secret | `skills/422-tax-id-report/create_tickets_2026_06_08.py:9` |
| HIGH | detect-secrets | `Slack Token` | Potential committed secret | `skills/422-tax-id-report/create_tickets_2026_06_08.py:9` |
| LOW | detect-secrets | `Base64 High Entropy String` | High-entropy string (verify; often a hash/cache, not a secret) | `skills/422-tax-id-report/create_tickets_2026_06_08.py:9` |
