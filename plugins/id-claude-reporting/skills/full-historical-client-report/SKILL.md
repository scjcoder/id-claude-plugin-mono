...
Navigate to `https://goldeneye.insidedesk.net/production/admin/snapshots` for
...
(async function() {
  ...
  for (const [fid, fname] of Object.entries(facilities)) {
    ...
    const base = `https://admin-api.production.insidedesk.net/pms-snapshot/?page_size=100&date_from=${monthStart}&date_to=${monthEnd}&facility=${fid}&page=`;
...
```
GET https://admin-api.production.insidedesk.net/facility/{id}/
```
...
```json
{
  ...
  "hubspot_company_url":"https://app.hubspot.com/contacts/19834291/company/12345",
  ...
  "locations": [
    {
      ...
      "hs_url":      "https://app.hubspot.com/contacts/19834291/record/2-14718097/..."
    }
  ],
  ...
  "cancellations": [
    {
      ...
      "hs_url":     "https://app.hubspot.com/contacts/19834291/record/2-33013991/..."
    }
  ],
  ...
  "tickets": [
    {
      ...
      "stage":     "Closed",
      "created":   "2025-11-04",
      "hs_url":    "https://app.hubspot.com/contacts/19834291/ticket/..."
    }
  ],
