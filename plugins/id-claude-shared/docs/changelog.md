...
### Added
- `aws-login` skill: canonical SSO login for InsideDesk AWS account (982534385600), consolidated from id-claude-ops, id-claude-reporting, and id-claude-integrations.
